...
|---|---|---|---|---|
| Windows | CI target/intended | local Rust workspace and Tauri build | Audio Share external-process lab | `CapyIO Speaker` planned; bounded render-APO bridge selected, no driver/APO source/build/install yet |
