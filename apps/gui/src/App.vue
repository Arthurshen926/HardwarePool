...
import { createHardwarePoolApi } from "./lib/api";
import type { UiCapability, UiSnapshot } from "./lib/types";

const api = createHardwarePoolApi();
...
<template>
  <main class="app-shell">
    <header class="topbar">
      <a class="brand" href="#overview" aria-label="HardwarePool home">
        <span class="brand__mark" aria-hidden="true">HP</span>
        <span>
          <strong>HardwarePool</strong>
    ...
    <section id="overview" class="hero-panel">
      ...
      <div class="hero-panel__diagram" aria-label="Current MVP data flow">
        ...
        <div class="node-box node-box--pc">
          ...
          <strong>HardwarePool endpoints</strong>
    ...
    <footer class="app-footer">
      <span>HardwarePool pre-alpha</span>
